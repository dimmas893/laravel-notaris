                ...
                <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="my-2">
                            <div class="container">
                                <ul class="nav nav-pills nav-fill mb-2" id="pills-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-1"
                                            role="tab">Pilih Layanan</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-2"
                                            role="tab">Persyaratan</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-3"
                                            role="tab">Pratinjau</a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="text-right mr-3">
                                <a class="btn btn-primary" id="pills-profile-tab" data-toggle="pill" href="#pills-2"
                                    role="tab">Selanjutnya</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade my-2" id="pills-2" role="tabpanel" aria-labelledby="pills-profile-tab">
                        <div class="container">
                            <ul class="nav nav-pills nav-fill mb-2" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-home-tab" data-toggle="pill" href="#pills-1"
                                        role="tab">Pilih Layanan</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" id="pills-profile-tab" data-toggle="pill" href="#pills-2"
                                        role="tab">Persyaratan</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-3"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="my-2">
                                    ...
                                    <div class="">
                                        <select class="form-control js-example-basic-multiple" width="100%"
                                            name="id_pemohon" id="pemohon_id">
                                ...
                                <div class="my-2">
                                    ...
                                    <input type="text" name="nik" class="form-control" v-model="infoPemohon.nik"
                                        placeholder="Masukan NIK">
                                </div>
                                <div class="my-2">
                                    <label for="no_kk">No KK</label>
                                    <input type="text" name="no_kk" class="form-control" v-model="infoPemohon.no_kk"
                                        placeholder="Masukan No KK">
                                </div>

                                <div class="my-2">
                                    <label for="alamat">Alamat</label>
                                    <textarea type="text" name="alamat"class="form-control" v-model="infoPemohon.alamat"
                                        placeholder="Masukan Alamat"></textarea>
                                </div>
                                <div class="my-2">
                                    <label for="no_hp">No HP</label>
                                    <input type="text" name="no_hp" class="form-control" v-model="isinohp"
                                        placeholder="Masukan No HP">
                                </div>
                                <div class="my-2">
                                    <label for="email">Email</label>
                                    <input type="email" name="email" class="form-control" v-model="isiemail"
                            ...
                            <div class="ml-1" v-for="item in infoLayanan">
                                <div class="row mt-4 ml-1">
                                    <b>
                                        <h5>@{{ item.nama_persyaratan }}</h5>
                                    </b>
                                    <input type="hidden" name="id_persyaratan{{ $p }}[]"
                                        v-model="item.id_persyaratan">
                                    <div class="col-6 my-2" v-if="item.entry_data === 1">
                                        <label class="mt-2" for="entry data">Entry Data </label>
                                        <input type="text" name="entry_data{{ $p }}[]"
                                            v-model="item.isiEntri" class="form-control" />
                                    </div>

                                    <div class="col-6 my-2" v-if="item.upload_data === 1">
                                        <label class="mt-2" for="upload data">upload Data</label>
                                        <input type="file" name="upload_data{{ $p }}[]"
                                            v-model="item.upload" class="form-control" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="mt-2 ml-2">
                                    <a class="btn btn-info" id="pills-profile-tab" data-toggle="pill" href="#pills-1"
                                        role="tab">Kembali</a>
                                    <a class="btn btn-primary" id="pills-contact-tab" data-toggle="pill" href="#pills-3"
                                        role="tab">Pratinjau</a>
                                </div>
                            </div>
                        </div>
                    ...
                    Pilih Layanan
                        ...
                        <div class="container">
                            <ul class="nav nav-pills nav-fill mb-2" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" id="pills-contact-tab" data-toggle="pill" href="#pills-3"
                                        role="tab">Pratinjau</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="">
                            <div class="row">
                                <div class="col-6">
                                    <div class="mt-2 ml-2">
                                        <a class="btn btn-info" id="pills-profile-tab" data-toggle="pill"
                                            href="#pills-2" role="tab">Kembali</a>
