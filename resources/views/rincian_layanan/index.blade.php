...
@section('content')
    ...
    <div class="modal fade" id="layanan_add_id" aria-labelledby="exampleModalLabel" data-bs-backdrop="static" aria-hidden="true">
                    ...
                    <div class="modal-body p-4 bg-light">
                        ...
                        <div class="my-2">
                            ...
                            <select class="form-control js-example-basic-single" style="width:100%;"
                                class="form-control js-example-basic-single" name="id_persyaratan">
    ...
    <div class="modal fade" id="editTUModal" aria-labelledby="exampleModalLabel" data-bs-backdrop="static"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="#" method="POST" id="edit_TU_form" enctype="multipart/form-data">
                    ...
                    <div class="modal-body p-4 bg-light">
                        ...
                        <div class="my-2">
                            <label for="id_persyaratan">Persyaratan</label>
                            <select style="width:100%;" class="form-control js-example-basic-single" name="id_persyaratan"
                                id="id_persyaratan">
                                {{-- <option disabled></option> --}}
                                @foreach ($persyaratan as $item)
                                    <option value="{{ $item->id }}">{{ $item->nama_persyaratan }}</option>
    ...
    <script>
        $(function() {
            ...
            $(document).on('click', '.editIcon', function(e) {
                ...
                let id = $(this).attr('id');
                $.ajax({
                    url: '{{ route('rincian_layanan-editlayanan') }}',
                    method: 'get',
                    data: {
                        id: id,
                        _token: '{{ csrf_token() }}'
            ...
            $("#edit_TU_form").submit(function(e) {
                ...
                $.ajax({
                    url: '{{ route('rincian_layanan-updatelayanan') }}',
                    method: 'post',
                    data: fd,
                    cache: false,
                    contentType: false,
