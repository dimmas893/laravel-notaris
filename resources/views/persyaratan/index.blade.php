...
@section('content')
                ...
                <form action="#" method="POST" id="persyaratan_form_add" enctype="multipart/form-data">
                    ...
                    <div class="modal-body p-4 bg-light">
                        <div class="my-2">
                            ...
                            <input type="text" name="nama_persyaratan" class="form-control"
          ...
          <input type="file" name="upload_data" class="form-control" placeholder="upload Data">
                        ...
                        <div class="my-2">
                            <label class="radio-inline">
                                <input type="radio" name="entry_data" class="optradio" value="1"> Entry Data
                            </label>
                        </div>
                        <div class="my-2">
                            <label class="radio-inline">
                                <input type="radio" name="upload_data" class="optradio" value="1"> Upload Data
                            </label>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="editTUModal" tabindex="-1" aria-labelledby="exampleModalLabel" data-bs-backdrop="static"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="#" method="POST" id="edit_TU_form" enctype="multipart/form-data">
                    ...
                    <div class="modal-body p-4 bg-light">
                        ...
                        <div class="my-2">
                            <label for="entry_data">Entry Data</label>
                            <input type="text" name="entry_data" id="entry_data" placeholder="Entry Data"
                                class="form-control">
                            </label>
                        </div>
                        <div class="my-2">
                            <label for="upload_data">Upload Data</label>
                            <input type="text" name="upload_data" id="upload_data" placeholder="Upload Data"
                                class="form-control">
                            </label>
                        </div>
                    </div>
